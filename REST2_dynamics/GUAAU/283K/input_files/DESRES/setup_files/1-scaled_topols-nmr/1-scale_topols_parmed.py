...
hot_idx_i = 9  # 0-based index of first hot residue
hot_idx_f = 13  # 0-based index of last hot residue

scale_ions = True
ion_idxs = [10930, 10938, 10944, 10951, 10963] #0-based residue indexes of hot ions.

scale_dihedrals = True
# atom types for definition of the unscaled dihedrals
unscaled_dihed_atypes = {'H', 'HA', 'H4', 'H5', \
                'C_desN', 'CA_desA', 'CA_desN', 'CB_desA', 'CB_desN', 'CK_desA', 'CK_desN', 'CM_desN', \
                'N*_desA', 'N*_desN', 'NA_desN', 'NB_desA', 'NC_desA', 'NC_desN', 'N2_desN', \
		'O'}
