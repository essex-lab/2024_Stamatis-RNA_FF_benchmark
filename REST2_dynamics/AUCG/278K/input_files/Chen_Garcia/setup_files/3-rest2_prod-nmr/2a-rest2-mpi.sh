...
# Run NVT REST2 for nrepl replicas with exchange attempts every 1000*0.002fs = 2ps
mpirun -np $NPROC gmx_mpi mdrun -plumed plumed.dat -v -multi $nrepl -s topol -replex 2000 -hrex -dlb no -maxh 60  &>> run.out
